    ...
    var _tab = {
        ...
        createTabDom: function () {
            ...
            var tpl = [
                ...
                '<li class="layui-this" lay-id="1"><i class="layui-icon">&#xe6c6;</i>&nbsp;用户查询<i class="layui-icon layui-unselect layui-tab-close">&#x1006;</i></li>',
                // '<li class="layui-this" lay-id="-1" data-url="' + _config.mainUrl + '"><i class="layui-icon">&#xe68e;</i> </li>',
                '</ul>',
                ...
                '<div class="layui-tab-item layui-show" style="margin-top:10px" lay-item-id="1">{{content}}</div>',
                '</div>',
                '</div>'
            ],
                _htm = tpl.join('');
        ...
        tabAdd: function (options) {
            ...
            titleHtm.push('</li>');
            var contentHtm = '<div class="layui-tab-item layui-show" style="margin-top:10px" lay-item-id="' + id + '">{{content}}</div>';
            switch (_config.renderType) {
                case renderType.page:
